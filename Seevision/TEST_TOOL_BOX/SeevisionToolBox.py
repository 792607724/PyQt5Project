...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listView_ScriptList = QtWidgets.QListView(self.groupBox_2)
        self.listView_ScriptList.setGeometry(QtCore.QRect(5, 21, 301, 511))
        self.listView_ScriptList.setObjectName("listView_ScriptList")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.listView_ScriptList.setToolTip(_translate("MainWindow", "脚本列表显示"))
