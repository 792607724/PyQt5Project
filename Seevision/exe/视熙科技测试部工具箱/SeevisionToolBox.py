...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_Script_GetBetteryHealthd = QtWidgets.QPushButton(self.groupBox_2)
        self.btn_Script_GetBetteryHealthd.setGeometry(QtCore.QRect(10, 50, 301, 21))
        self.btn_Script_GetBetteryHealthd.setObjectName("btn_Script_GetBetteryHealthd")
        ...
        self.menuItem_logClear = QtWidgets.QAction(MainWindow)
        self.menuItem_logClear.setObjectName("menuItem_logClear")
        self.menuItem_logDelete = QtWidgets.QAction(MainWindow)
        self.menuItem_logDelete.setObjectName("menuItem_logDelete")
        self.menuItem_stopScript = QtWidgets.QAction(MainWindow)
        self.menuItem_stopScript.setObjectName("menuItem_stopScript")
        self.menu_Log.addAction(self.menuItem_logClear)
        self.menu_Log.addAction(self.menuItem_logDelete)
        self.menu.addAction(self.menuItem_stopScript)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_Script_GetBetteryHealthd.setToolTip(_translate("MainWindow", "点击运行getBatteryHealthd.py脚本"))
        self.btn_Script_GetBetteryHealthd.setText(_translate("MainWindow", "getBatteryHealthd.py"))
        self.groupBox_3.setTitle(_translate("MainWindow", "脚本运行输出内容"))
        self.menu_Log.setTitle(_translate("MainWindow", "log控制"))
        self.menu.setTitle(_translate("MainWindow", "脚本控制"))
        self.menuItem_logClear.setText(_translate("MainWindow", "清除log输出显示内容"))
        self.menuItem_logDelete.setText(_translate("MainWindow", "删除log文件./log.txt"))
        self.menuItem_stopScript.setText(_translate("MainWindow", "停止脚本"))
